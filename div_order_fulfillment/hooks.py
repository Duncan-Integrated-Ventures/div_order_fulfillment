...
doctype_js = {
	"Packing Slip": "public/js/custom/packing_slip.js",
	"Shipping Export Adapter": "public/js/custom/shipping_export_adapter.js",
}
doctype_list_js = {
	"Packing Slip": "public/js/custom/packing_slip_list.js",
}
...
doc_events = {
	"Packing Slip": {
		"validate": "div_order_fulfillment.api.packing_slip_spread.validate",
	},
}
